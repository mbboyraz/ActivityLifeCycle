...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { //Activity başlarken çağrılır.
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {     //Seçenekler menüsü ilk kez görüntülendiğinde ve sadece bir kez çağrılır.
        Log.e(MAIN_TAG,"onCreateOptionsMenu");
        return super.onCreateOptionsMenu(menu);
    }

    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {        //Seçenekler menüsü görüntülendiği her seferinde çağrılır.
